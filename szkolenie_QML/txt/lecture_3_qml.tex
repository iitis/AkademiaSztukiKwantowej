...
\begin{frame}{Variational quantum circuit}
    \centering
    \includegraphics[scale=1.5]{pics/qnn/variational_circuit.pdf}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}[fragile]{Variational quantum algorithm I}
	...
	\end{center}
	\lstinputlisting[basicstyle=\fontsize{6pt}{7pt}\selectfont]{../src/pennylane_example.py}
...
\def\mylisting<#1>#2#3{\only<#1>{%
	\lstinputlisting[basicstyle=\fontsize{6pt}{7pt}\selectfont, language=Python, keywordstyle=\color{teal}\bfseries, firstline=#2, lastline=#3, firstnumber=#2]%
	{\mycode}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
