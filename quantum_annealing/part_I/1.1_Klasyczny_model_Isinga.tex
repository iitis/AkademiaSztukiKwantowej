...
\begin{document}
		  ...
		  \begin{columns}[T]
		  	...
		  	\begin{column}{.48\textwidth}
		  		...
		  		\begin{itemize}
		  			...
		  			\item Przykłady: Poprzeczne pole Isinga, Atomy Rydberga
		  		\end{itemize}
		  	\end{column}
		  \end{columns}
	\end{frame}
	...
	\begin{frame}
		...
		Opisuje system "spinów", tj. obiektow, ktore moga przyjać jeden z dwóch stanow: $\uparrow$ (numeryczna wartosc 1) lub $\downarrow$ (numeryczna wartosc -1). Matematycznie $i$-ty spin oznaczamy jako $\sigma^{z}_i$.
